...
public class HashTester {
	public static void main(String[] args) throws FileNotFoundException {
		...
		for (int i = 0; i < alpha.length; i++) {
			...
			int avg = Table.getAverageLength();
			int longest = Table.getMaxLength();
			...
			System.out.println(
					...
					"Largest LL and Average LL size: " + longest + ", " + avg + "\n\n\n\n"
					);
		}
	}
}
